                    ...
                    <div class="container" style="margin-top:20px;">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-hashtag" aria-hidden="true"></i>&emsp;Fetcher Code &emsp;</span>
                            </div>
                            <?php
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-book" aria-hidden="true"></i>&emsp;Fetcher Name&emsp;</span>
                            </div>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-phone" aria-hidden="true"></i>&emsp;Contact Number</span>
                            </div>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-calendar" aria-hidden="true"></i>&emsp; Registered Date </span>
                            </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fa fa-id-badge" aria-hidden="true"></i>&emsp; Student Code</span>
                                        </div>
                                ...
                                <div class="col-md-5">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fa fa-heart" aria-hidden="true"></i>&emsp;Relationship</span>
                                        </div>
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <button id="addinfototable" class="btn bg-light btn-sm" style="margin-top:3px;"><i class="fa fa-plus" aria-hidden="true"></i>&emsp;Add&emsp;</button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fa fa-address-card" aria-hidden="true"></i>&emsp;Student Name</span>
                                        </div>
