...
//function ezPlaceData($xpos,$ypos,$data,$font_size, $decimal, $align){
...
function ezplacetextwrap($xpos,$ypos,$data,$font_size,$align,$xwidth=100,$xspacing=12){
	...
	while ($xdata!="")
	{	
	    $xdata=$this->addTextWrap2($xpos,$xTop,$xwidth,$font_size,$xdata,$align,0);    
	    $xTop-=$xspacing;
	    $xwrap = true;
	}
	if($xwrap)
